...
/**
 * Use HLF CA services to create a new admin certificate for the organization and add to the file system wallet. 
 * Org for the pharma network: "manufacturer", "distributor", "retailer", "transporter", "consumer" 
 * @param {*} org 
 *  
 * @returns 
 */
async function main(org) {
  try {
    ...
    let connectionProfile = yaml.safeLoad(
      ...
      fs.readFileSync(getConnectionProfilePath(org), "utf8")
    );

    // Create a new CA client for interacting with the CA.
    let caInfo =
      connectionProfile.certificateAuthorities["ca." + org + ".pharma-network.com"];
